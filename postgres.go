...
func (r *pgRepo) GetCrosspostMaxChat(tgChatID int64, ownerID int64) (int64, string, bool) {
        ...
        var dir string
        err := r.db.QueryRow(
                "SELECT max_chat_id, direction FROM crossposts WHERE tg_chat_id = $1 AND ($2 = 0 OR tg_owner_id = $2 OR owner_id = $2) AND deleted_at = 0",
...
func (r *pgRepo) GetCrosspostTgChat(maxChatID int64, ownerID int64) (int64, string, bool) {
        ...
        var dir string
        err := r.db.QueryRow(
                "SELECT tg_chat_id, direction FROM crossposts WHERE max_chat_id = $1 AND ($2 = 0 OR owner_id = $2 OR tg_owner_id = $2) AND deleted_at = 0",
